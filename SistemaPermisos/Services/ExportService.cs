...
namespace SistemaPermisos.Services
{
    public class ExportService : IExportService
    {
        ...
        public async Task<byte[]> ExportPermisosToExcelAsync(IEnumerable<Permiso> permisos)
        {
            ...
            {
                // Registrar la excepción
                _logger.LogError(ex, "Error al exportar permisos a Excel");
                throw;
            }
        }
        ...
        public async Task<byte[]> ExportPermisosToPdfAsync(IEnumerable<Permiso> permisos)
        {
            ...
            {
                // Registrar la excepción
                _logger.LogError(ex, "Error al exportar permisos a PDF");
                throw;
            }
        }
        ...
        public async Task<byte[]> ExportOmisionesToExcelAsync(IEnumerable<OmisionMarca> omisiones)
        {
            ...
            {
                // Registrar la excepción
                _logger.LogError(ex, "Error al exportar omisiones a Excel");
                throw;
            }
        }
        ...
        public async Task<byte[]> ExportOmisionesToPdfAsync(IEnumerable<OmisionMarca> omisiones)
        {
            ...
            {
                // Registrar la excepción
                _logger.LogError(ex, "Error al exportar omisiones a PDF");
                throw;
            }
        }
        ...
        public async Task<byte[]> ExportAuditLogToExcelAsync(IEnumerable<AuditLog> auditLogs)
        {
            ...
            {
                // Registrar la excepción
                _logger.LogError(ex, "Error al exportar logs de auditoría a Excel");
                throw;
            }
        }

        public async Task<byte[]> ExportAuditLogToPdfAsync(IEnumerable<AuditLog> auditLogs)
        {
            try
            {
                using (var memoryStream = new MemoryStream())
            ...
            {
                // Registrar la excepción
                _logger.LogError(ex, "Error al exportar logs de auditoría a PDF");
                throw;
            }
        }
    }
